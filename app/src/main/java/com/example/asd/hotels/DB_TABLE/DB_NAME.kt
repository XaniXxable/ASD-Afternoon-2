...
object DBName {
    ...
    const val SQL_DELETE_HOTEL: String = "DROP IF TABLE EXISTS ${HOTEL_TABLE_NAME};"

    const val SQL_DELETE_CUSTOMER: String = "DROP IF TABLE EXISTS ${CUSTOMER_TABLE_NAME};"
    
    const val SQL_DELETE_RATING: String = "DROP IF TABLE EXISTS ${RATING_TABLE_NAME};"

    const val SQL_DELETE_CATEGORY: String =  "DROP IF TABLE EXISTS ${CATEGORY_TABLE_NAME};"
  
    const val SQL_DELETE_ACTIVITY: String = "DROP IF TABLE EXISTS ${ACTIVITY_TABLE_NAME};"
    
    const val SQL_DELETE_ACTIVITY_AVAILABILITY: String = "DROP IF TABLE EXISTS ${ACTIVITY_AVAILABILITY_TABLE_NAME};"
            
    const val SQL_DELETE_USER: String = "DROP IF TABLE EXISTS ${USER_TABLE_NAME};"    

    const val SQL_DELETE_PHOTOGALLERY: String = "DROP IF TABLE EXISTS ${PHOTOGALLERY_TABLE_NAME};"
}