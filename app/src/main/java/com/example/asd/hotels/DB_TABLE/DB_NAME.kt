...
object DBName {
    ...
    const val SQL_DELETE_HOTEL: String = "DROP TABLE IF EXISTS ${HOTEL_TABLE_NAME};"

    const val SQL_DELETE_CUSTOMER: String = "DROP TABLE IF EXISTS ${CUSTOMER_TABLE_NAME};"
    
    const val SQL_DELETE_RATING: String = "DROP TABLE IF EXISTS ${RATING_TABLE_NAME};"

    const val SQL_DELETE_CATEGORY: String =  "DROP TABLE IF EXISTS ${CATEGORY_TABLE_NAME};"
  
    const val SQL_DELETE_ACTIVITY: String = "DROP TABLE IF EXISTS ${ACTIVITY_TABLE_NAME};"
    
    const val SQL_DELETE_ACTIVITY_AVAILABILITY: String = "DROP TABLE IF EXISTS ${ACTIVITY_AVAILABILITY_TABLE_NAME};"
            
    const val SQL_DELETE_USER: String = "DROP TABLE IF EXISTS ${USER_TABLE_NAME};"    

    const val SQL_DELETE_PHOTOGALLERY: String = "DROP TABLE IF EXISTS ${PHOTOGALLERY_TABLE_NAME};"
